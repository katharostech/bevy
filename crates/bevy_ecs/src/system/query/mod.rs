    ...
    Q::Fetch: for<'b> Fetch<'b, State = ()>,
{
    ...
    pub fn iter(&self) -> QueryIter<'static, '_, Q, ()>
    where
    ...
    pub fn iter_mut(&mut self) -> QueryIter<'static, '_, Q, ()> {
        self.query.iter_mut()
    }
    ...
    pub unsafe fn iter_unsafe(&self) -> QueryIter<'static, '_, Q, ()> {
    ...
    where
        Q::Fetch: for<'b> Fetch<'b, State = ()>,
    {
        self.query.entity_unsafe(entity)
    }
