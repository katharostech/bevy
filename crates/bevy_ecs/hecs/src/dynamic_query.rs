...
// use crate::{archetype::ComponentIdSet, Access, Archetype, Entity, TypeInfo};
...
// impl DynamicQuery {
//     /// Add an immutable query given the [`TypeInfo`]
//     ///
//     /// # Panics
//     /// Panics if the component has already been added to the query.
//     pub fn push(&mut self, info: TypeInfo) {
...
//     /// Add a mutable query given the raw [`TypeInfo`]
//     ///
//     /// # Panics
//     /// Panics if the component has already been added to the query.
//     pub fn push_mut(&mut self, info: TypeInfo) {
//         if self.info_collides(&info) {
//             panic!("Component already added to query: {:?}", info);
//         }
